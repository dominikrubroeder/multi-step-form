...
![Design preview for the Multi-step form coding challenge](frontendmentor-files/design/desktop-preview.jpg)
...
the [`README-template.md`](frontendmentor-files/README-template.md) file in this starter code.
