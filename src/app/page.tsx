...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between lg:p-24">
      <h1 className="hidden">Multi step form</h1>
      <div className="bg-app-alabaster grid gap-4 w-full lg:p-4 lg:rounded-2xl lg:bg-white lg:grid-cols-[auto_1fr] lg:max-w-4xl">
        <OrderProvider>
          <Sidebar />
          <StepLayout />
        </OrderProvider>
