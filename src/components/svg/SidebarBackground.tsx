export default function SidebarBackground() {
    return <svg xmlns="http://www.w3.org/2000/svg" width="274" height="568" fill="none" viewBox="0 0 274 568">
        ...
        <g mask="url(#a)">
            <path fill="#6259FF" fillRule="evenodd"
                  ...
                  clipRule="evenodd"/>
            <path fill="#F9818E" fillRule="evenodd"
                  ...
                  clipRule="evenodd"/>
            <path stroke="#fff" strokeLinecap="round" strokeLinejoin="bevel" strokeWidth="5"
